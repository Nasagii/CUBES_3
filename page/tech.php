...
if (empty($select_data)) 
	...
	{
	?>
		<div class="gestion_tech">
			<div class="gestion_animaux">
				<h2 class="cat" > Gestion des Animaux</h2>
				<a class="animaux" href="index.php?page=gestion_animaux">
					<p> Ajouter un animal</p>
				</a>
				<a class="photo" href="index.php?page=gestion_photos" >
					<p> Editer les photos d'un animal</p>
				</a>
			</div>
			<div class="gestion_animaux">
				<h2 class="cat" > Gestion des admin</h2>
				<a class="animaux" href="index.php?page=gestion_utilisateur">
					<p> Ajouter un utilisateur admin</p>
				</a>

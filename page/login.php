...
$email_from_alias="vincenzo.gay";
$object="Votre compte a etait créé avec succés.";
$body="Cher(e)".$nom.",<br><br>

Nous tenons à vous remercier d'avoir choisi notre service et nous vous souhaitons la bienvenue.<br><br>

Nous sommes heureux de vous informer que votre compte a été créé avec succès. <br>
Vous pouvez désormais vous connecter à votre compte en utilisant les informations suivantes :<br><br>

Nom d'utilisateur : ".$email."<br>
Mot de passe : ".$mdp."<br><br>

Veuillez noter que votre nom d'utilisateur et votre mot de passe sont sensibles à la casse. <br>
Assurez-vous de les saisir correctement lors de la connexion.<br><br>

Nous vous rappelons de garder vos informations de connexion confidentielles et de ne les partager avec personne. <br>

Nous sommes ravis de vous accueillir parmi nos utilisateurs et nous espérons que notre service répondra à vos attentes. <br>
Si vous avez des questions ou besoin d'une assistance supplémentaire, n'hésitez pas à nous contacter à l'adresse vincenzoo.gay@gmail.com.<br><br>
...
if($mail->SMTPAuth){
   ...
   $mail->Password   = 'qbupabcysmnmhnbl';         //Mot de passe de l'adresse email à utiliser
}
...
if($Use_HTML == true){
    ...
    L'équipe de SPA"); 		                //Le contenu au format HTML
    $mail->IsHTML(true);
 }
